...
| Cisco, Juniper, Palo Alto, Fortinet, Arista, SONiC, cloud SGs | Deterministic synthetic parsing fixtures now cover the first five; policy/remediation coverage remains narrower | Say "five-vendor synthetic parsing corpus"; do not imply equal compliance/remediation depth or independent real-device validation. |
